...
libxpm-dev libxt-dev python python-dev python3 python3-dev python3-pip \
ruby-dev lua5.3 liblua5.3-dev libperl-dev git libgpm-dev gpm cmake \
curl bash-completion git-extras python3-venv
